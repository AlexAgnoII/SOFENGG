    ...
    function checkPasswordField(passwordField) {
        ...
        console.log("checkPasswordField is used");
        //Check if idNumber follows constraint.
        if(checkPassword(value)|| value == "" || value == "null") {
        ...
        checkPasswordEqual(document.getElementById('nPasswordConfirm'),document.getElementById('newPassword'));
    }
	...
	function constraintPassword(password, newPass, newPassRe) {
		...
		if(password === newPass) {
            ...
            $('#npwError2').show();
            $('#newPassword').css("border-color", "indianred");
            console.log("password_invalid_2");
		}
