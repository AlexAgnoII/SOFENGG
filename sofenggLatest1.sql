...
INSERT INTO `admin` VALUES (1,'$31$16$bzKU3QOXupmf-WojJPrAC6rnU8SqgWnavsZvc3f5fQQ','vicedeanSA@dlsu.edu.ph');
...
INSERT INTO `college` VALUES (1,'College of Computer Studies'),(2,'College of Business'),(3,'College of Education'),(4,'College of Engineering'),(5,'College of Liberal Arts'),(6,'College of Science'),(7,'School of Economics');
/*!40000 ALTER TABLE `college` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `expiration_table`
--

DROP TABLE IF EXISTS `expiration_table`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `expiration_table` (
  `expiringID` int(11) NOT NULL AUTO_INCREMENT,
  `email` varchar(45) DEFAULT NULL,
  `token` varchar(100) DEFAULT NULL,
  `time` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`expiringID`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `expiration_table`
--

LOCK TABLES `expiration_table` WRITE;
/*!40000 ALTER TABLE `expiration_table` DISABLE KEYS */;
/*!40000 ALTER TABLE `expiration_table` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `relative` VALUES (20,22,'Who','Sibling','You','2000-12-01'),(22,22,'Alex  II','Sibling','Agno','1997-12-03'),(23,22,'Papa bear','Father','Bear','2000-12-01'),(24,22,'GALING KO NAMAN','Mother','Bear','2000-12-01'),(25,22,'Charlie','Sibling','The Unicorn','2000-12-10'),(26,23,'Ate bear','Sibling','Bear','2000-12-01'),(27,23,'asd','Sibling','asd','2000-12-01'),(28,23,'Papa bear','Father','Bear','2000-12-01'),(29,23,'Mama bear','Mother','Bear','2000-12-01'),(30,25,'Ate bear','Sibling','Bear','2000-12-01'),(31,25,'meow','Sibling','asdasasd','2000-04-01'),(32,25,'Alex','Father','Agno','2000-12-01'),(33,25,'Jess ','Mother','Gano','2000-12-01'),(34,25,'sasdads','Sibling','asdasd','2000-12-01'),(35,25,'aasdasdadasd','Sibling','asdasd','2000-12-01');
...
-- Dump completed on 2017-12-15 18:02:57
