			                        ...
			                        <div class="wrap">
			                            ...
			                            <div class="f" id="INposition">
			                                ...
			                                <c:forEach items="${internalList}" begin="0" end="${internalSize}" var="i" varStatus="loop">
			                               		...
			                               		<a class="waves-effect waves-light btn delete deleteINTERNAL btdelete" data-index="inDELETE-${loop.index}">DELETE</a>
			                               	</c:forEach>  
			                            </div>
			                        </div>
		                        </c:otherwise>
		                        ...
		                        <div class="wrap">
		                            ...
		                            <div class="f" id="EXposition">
		                                ...
		                                <c:forEach items="${externalList}" begin="0" end="${externalSize}" var="i" varStatus="loop">
		                            		...
		                            		<a class="waves-effect waves-light btn delete deleteEXTERNAL btdelete" data-index="exDELETE-${loop.index}" >DELETE</a>
		                            	</c:forEach>
		                            </div>
		                        </div>
	                        </c:otherwise>
